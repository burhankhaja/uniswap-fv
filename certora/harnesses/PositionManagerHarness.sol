...
import "src/libraries/PositionInfoLibrary.sol";
...
contract PositionManagerHarness is PositionManager {
    ...
    function emptyPositionInfo() external view returns (PositionInfo info) {
    ...
    function getLiquidityOf(
        ...
        liquidity = _getLiquidity(tokenId, poolKey, tickLower, tickUpper);
    }
}
